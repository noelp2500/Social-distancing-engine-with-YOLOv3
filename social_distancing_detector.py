...
print("[INFO FOR THE USER] accessing video stream...")
...
while True:
    ...
    text = "Visible Social Distancing Violations: {}".format(len(violate))
    ...
    if writer is not None:
        print("[INFO FOR THE USER] writing stream to output")
        writer.write(frame)
